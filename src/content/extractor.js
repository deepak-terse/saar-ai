...
(() => {
	// Context window: 8192 tokens => ~6K words => ~40K chars
	const MAX_CHARS = 30000; // ~75% for optimal performance and accuracy
	...
	const extract = () => {
		...
		const finalText = truncated ? text.slice(0, MAX_CHARS).trim() : text;
