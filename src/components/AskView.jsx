...
export function AskView({ active, page, setBanner }) {
        ...
        initialPrompts: [
          {
            role: "system",
            content:
              "You are a reading assistant. Answer questions using only the page content " +
              "provided below. If the answer isn't in the page, say so plainly instead of guessing.\n\n" +
              `Title: ${page.title}\nURL: ${page.url}\n\n${page.text}`,
          },
        ],
        monitor: (monitor) => {
